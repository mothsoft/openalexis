...
//        String entryContent = document.getContent();
//        String etag = null;
...
//         return this.transactionTemplate.execute(new
//         TransactionCallback<Document>() {
//        
//         public Document doInTransaction(TransactionStatus txStatus) {
//         return
//         DocumentRetrievalTaskImpl.this.documentDao.findAndLockOneDocument(DocumentState.DISCOVERED);
//         }
//        
//         });
//        return null;
//    }
//
//    private void onErrorState(final String documentId, final DocumentState errorState) {
...
//         DocumentRetrievalTaskImpl.this.documentDao.get(documentId);
...
//    }
//
//    private void updateStateAndQueueForParsing(final String documentId, final String content, final String etag,
...
//
//        final DocumentContent documentContent = new DocumentContent(documentId, content);
//        document.setDocumentContent(documentContent);
//
//        requestParse(documentId, content);
//    }
//
//    private String requestParse(final String documentId, final String content) {
