...
//	this.spring_length = 30; // base resting length of springs
//}
//
//Graph.prototype.createVertex = function( name, onClickListener, isRoot) { 
//	// create an SVG rectangle, attach additional attributed to it
//	var vertex = document.createElementNS(this.svg, "rect");
//    var color = "#333";
//    
//	if(isRoot) {
//		// start with the root node centered and highlighted
//		vertex.posx = this.width / 2;
//		vertex.posy = this.height / 2;
//		color = "#356aa0";
//	} else {
...
//	
//	// event listener
//    vertex.addEventListener("click", function() {onClickListener(vertex);}, false);
//    vertex.textLabel.addEventListener("click", function() {onClickListener(vertex);}, false);
//	
